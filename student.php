<?php	
	...
	else 
	{
		...
		{
			cancel_student_plotted_subject($ctr);	
		}
							...
							<form method="post" class="form">
								<center>
									<input type="submit" name="add" value="Submit" class="btn btn-primary btn-lg">&nbsp&nbsp																		
										<a href="student.php?id=<?php echo $ctr; ?>">										    	
											<button type="submit" name="cancel" class="btn btn-warning btn-lg" name="login">Cancel</button>												
										</a>
								</center>
							</form>
						</div>	
